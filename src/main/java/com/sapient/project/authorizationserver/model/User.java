package com.sapient.project.authorizationserver.model;
...
public class User {
	...
	@Column(name = "is_2fa_enabled", nullable = false, length = 20)
	private String is2faEnabled;

	@Column(name = "2fa_default_type", nullable = false, length = 20)
